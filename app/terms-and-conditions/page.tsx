    ...
    return (
        <main className="min-h-screen bg-white text-gray-800">
            ...
            <div className="container mx-auto px-4 py-12 max-w-4xl">
                <h1 className="text-4xl font-bold text-gray-900 mb-2 font-serif">Terms & Conditions</h1>
                <p className="text-gray-500 mb-8 border-b pb-4">Last updated on 12-01-2026 23:19:33</p>

                <div className="prose prose-lg max-w-none space-y-6 text-justify leading-relaxed">
                    <p>
                        These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding
                        agreement by and between <strong>SANWARIYA SETH FOUNDATION TRUST</strong>, (“Website Owner” or “we”
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-8">The use of this website or availing of our Services is subject to the following terms of use:</h3>
                    ...
                    <ul className="list-disc pl-6 space-y-4">
                        ...
                        <li>
                            ...
                            jurisdiction of the courts in <strong>Jhansi, UTTAR PRADESH</strong>.
                        </li>
                        <li>
